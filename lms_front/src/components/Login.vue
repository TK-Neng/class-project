        ...
        <div class="bg-white rounded-2xl p-8 max-w-md mx-auto w-full backdrop-blur-sm bg-opacity-90 
          ...
          <form class="space-y-6">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <input name="username" type="text" required v-model="username"
                  class="w-full text-gray-800 px-4 py-3 rounded-lg border border-gray-300
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <input :type="showPassword ? 'text' : 'password'" name="password" required v-model="password"
                  class="w-full text-gray-800 px-4 py-3 rounded-lg border border-gray-300
                  focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-200
                  outline-none text-sm"
                  placeholder="Enter password" />
                <svg @click="togglePasswordVisibility" xmlns="http://www.w3.org/2000/svg" fill="#94a3b8" stroke="#94a3b8"
                  ...
                  <path v-else d="M64 24C22.127 24 1.367 60.504.504 62.057a4 4 0 0 0 0 3.887C1.367 67.496 22.127 104 64 104s62.633-36.504 63.496-38.057a4 4 0 0 0 0-3.887C126.633 60.504 105.873 24 64 24zm0 72c-31.955 0-50.535-24.775-55.293-31.994C13.465 56.795 32.146 32 64 32c31.955 0 50.535 24.775 55.293 31.994C114.535 71.205 95.854 96 64 96zm0-56c-13.234 0-24 10.766-24 24s10.766 24 24 24 24-10.766 24-24-10.766-24-24-24zm0 40c-8.822 0-16-7.178-16-16s7.178-16 16-16 16 7.178 16 16-7.178 16-16 16z"></path>
                </svg>
              </div>
            </div>
            ...
            <button type="button" @click="matchLogin(username, password)"
              class="w-full py-3.5 px-4 text-sm font-semibold rounded-lg text-white bg-blue-600 
